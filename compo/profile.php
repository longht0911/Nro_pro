...
<a class="me-3 py-2 text-dark text-decoration-none" target="_blank" href="https://zalo.me/g/fvudzw630">Box Zalo</a>
...
<style>
    ...
    <a href="./push.php" class="list-group-item list-group-item-action ">
            ...
            <h5>Tài khoản</h5>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <th><div class="w-50" style="font-size:16px">long</div></th>
                    </tr>
                  <tr>
                        <th scope="row">Trạng Thái</th>
                        <td><div class="w-50" style="font-size:16px">Chưa kích hoạt</div></td>
                    </tr>
                    <tr>
                        <th scope="row">KCoin</th>
                        <td><div class="text-danger"><b>0 KCoin</b></div></td>
                    </tr>
                    <tr>
                        <th scope="row">Tổng đã nạp</th>
                        <td><div class="text-danger"><b>0 KCoin</b>
                        </div></td>
                    </tr>
                    <tr>
                        <th scope="row">Chuyển map</th>
                        <form class="form-signin" action="" method="post"></form>
                             
                              <td><button class="btn btn-lg btn-dark btn-block" style="border-radius: 10px;" type="submit" name="button1">Chuyển nhân vật về làng Aru</button>
                            </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-outline-primary" href="./index.php" style="font-weight: 500">Đăng xuất</a>
                        </td>
                    </tr>
                </tbody>
            </table>
